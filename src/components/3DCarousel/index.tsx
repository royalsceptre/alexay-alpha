    ...
    return (
      <div
        ...
        style={{
          height: "400px",
          background:
            "linear-gradient(146.92deg,#a8dcea,#52bad5 31.79%,#23bdac 72.03%,#02bf8f)",
        }}
      >
              ...
              {this.state.slides.map((slider, index) => {
                return (
                  <div className={slider.class} key={index}>
                    ...
                    >
                      <div>
                      <svg className="fill-[white]" width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M20 .755l-14.374 11.245 14.374 11.219-.619.781-15.381-12 15.391-12 .609.755z"/></svg>
                      </div>
                    </div>
                    <div
                    ...
                    >
                      <div>
                      <svg className="fill-[white]" width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M4 .755l14.374 11.245-14.374 11.219.619.781 15.381-12-15.391-12-.609.755z"/></svg>
                      </div>
                    </div>
