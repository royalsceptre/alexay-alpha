        ...
        <>
            <div className="mt-[87px] mb-[93px]">
                ...
                <ul className="pl-[0] m-0 l-[-11px]">
                    <li className="bg-[url('https://ww2-secure.justanswer.com/static/sip/btc/how-it-works/connect.svg')] block mb-[61px] pl-[98px] bg-no-repeat bg-top-[17px] bg-left-[24px]">
